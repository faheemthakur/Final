			...
			<div id="stickerside">
				<div class="sidebar fix" >
						<ul>
							...
							<li><span class="spcl"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Moderator Area</span></li>
								<ul>
									<li><a href="mgment_index.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Login</a></li>
									<li><a href="mgment_reg.php"><i class="fa fa-user-plus" aria-hidden="true"></i> Register</a></li>
								</ul>
